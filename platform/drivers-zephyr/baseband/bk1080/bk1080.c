...
static const struct gpio_dt_spec clk_gpio = GPIO_DT_SPEC_GET(BK1080_NODE,
                                                             i2c_clk_gpios);
static const struct gpio_dt_spec data_gpio = GPIO_DT_SPEC_GET(BK1080_NODE,
                                                              i2c_data_gpios);
static const struct gpio_dt_spec power_gpio = GPIO_DT_SPEC_GET(BK1080_NODE,
                                                               power_gpios);
...
static struct bk1080_data {
    bool initialized;
} bk1080_device_data = { .initialized = false };
